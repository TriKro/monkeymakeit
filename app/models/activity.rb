class Activity < ActiveRecord::Base
  ...
  # TODO: Change to belong to user through UserSession
  belongs_to :user # the user that causes the activity
  belongs_to :user_session # the session that the activity was performed under

  belongs_to :target, :polymorphic => true # the activity target(e.g. if you vote an answer, the target can be the answer )
  belongs_to :subtarget, :polymorphic => true # e.g if you rate an answer, target is your answer, secondary target is your rating.
